...
class BestGunShopRecyclerView : RecyclerView.Adapter<BestGunShopRecyclerView.ViewHolder>() {
    ...
    private val dummy : List<BestGunShopData> = listOf(
        BestGunShopData(1, R.drawable.gunshop_img_bestshoplogo_1, "코코곰신", "군입대 준비물, 군인용품 직배송"),
        BestGunShopData(2, R.drawable.gunshop_img_bestshoplogo_2, "과자선물", "12시까지 주문하면 내일도착"),
        BestGunShopData(3, R.drawable.gunshop_img_bestshoplogo_3, "그라펜", "남성전용 화장품 몰"),
        BestGunShopData(4, R.drawable.gunshop_img_bestshoplogo_4, "곰신몰", "군인과 곰신을 위한 공동구매"),
        BestGunShopData(5, R.drawable.gunshop_img_bestshoplogo_5, "나이키 남성", "컬렉션, 스포츠, 아웃웨어, 운동화")
    )
